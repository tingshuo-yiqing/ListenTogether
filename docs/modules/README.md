...
这些说明基于 2026-09-21 项目源码整理。“当前实现”是已有行为；“下一阶段”均为待开发。
主计划见 [下一阶段方案](../next-development-plan.md)，统一规范见 [文档与注释规范](../development-standards.md)。
...
| 校时与同步算法 | SyncMath、PlaybackPolicy | [04 同步](04-synchronization.md) |
